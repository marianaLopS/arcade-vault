---
name: spec-impl
description: Implementa una especificación aprobada. Valida que el estado sea «Aprobado» (en cualquier idioma), crea una rama de Git con el nombre de la especificación, cambia a ella e inicia la implementación paso a paso, haciendo pausas para revisar las diferencias (diffs).
