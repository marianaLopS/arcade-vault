---
name: spec
description: Diseña y desarrolla especificaciones siguiendo el método basado en especificaciones. Formula preguntas aclaratorias antes de proponer la estructura y elabora la especificación sección por sección. Utiliza este enfoque al iniciar una funcionalidad de gran envergadura, antes de escribir código.
